...
IMG ?= forgejo.thecloudroute.com/tom/rpc-operator:latest
...
KIND_CLUSTER ?= rpc-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name rpc-operator-builder
	$(CONTAINER_TOOL) buildx use rpc-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm rpc-operator-builder
	rm Dockerfile.cross
